                ...
                <div class="card-body p-0">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3 my-3">
                            <h3>{{__("Pages")}}</h3>
                            <p>{{__("Page Setting")}}</p>
                            <a href="{{ route('settings.pages')}}" class="card-cta">{{__("Change Setting")}} <i class="fas fa-chevron-right mx-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3 my-3">
                            <h3>{{__("Seo")}}</h3>
                            <p>{{__("Seo Setting")}}</p>
                            <a href="{{ route('settings.seo')}}" class="card-cta">{{__("Change Setting")}} <i class="fas fa-chevron-right mx-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
