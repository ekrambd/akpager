                ...
                <div id="post-type" class="card h-auto mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3 @error('title') has-error @enderror">
                            ...
                            <input name="title" value="{{ old('title', $page->title ) }}" class="form-control  @error('title')  is-invalid @enderror">
                            @error('title')
                            ...
                            <div class="mb-1 row slug-edit">
                                ...
                                {{-- <div class="py-1 m-0">
                                  ...
                                  <div class="input-group mb-1">
                                    <input name="slug" type="text" class="form-control  @error('slug')  is-invalid @enderror" value="{{ old('slug', $page->slug?? '' ) }}">
                        ...
                        <div class="mb-3 @error('summary') has-error @enderror">
                            ...
                            <textarea name="summary" class="form-control @error('summary')  is-invalid @enderror">{{ clean(old('summary', $page->summary)) }}</textarea>
                            @error('summary')
                                <small class="invalid-feedback">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <select class="w-100 form-control mr-sm-2" name="layout">
                            @foreach ($layouts as $lk => $lv)
                                <option value="{{ $lk }}"   @if($lk == $page->layout)  selected @endif>{{ $lv }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
