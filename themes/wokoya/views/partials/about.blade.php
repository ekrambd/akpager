						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								...
								<div class="about-cn">
									...
									<ul>
										<li>{!! clean(__('theme::about.introname')) !!}</li>
										<li>{!! clean(__('theme::about.introskype')) !!}</li>
										<li>{!! clean(__('theme::about.introemail')) !!}</li>
									</ul>
								</div>
							</div> <!-- end col-6 -->
							<div class="col-md-6 col-sm-12">
								...
								<div class="about-cn">
									<ul>
										<li>{!! clean(__('theme::about.introaddress')) !!}</li>
										<li>{!! clean(__('theme::about.introdateofbirth')) !!}</li>
										<li>{!! clean(__('theme::about.introphone')) !!}</li>
									</ul>
								</div>
							</div> <!-- end col-6 -->
						</div> <!-- end row -->
