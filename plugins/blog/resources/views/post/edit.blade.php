                ...
                <div id="post-type" class="card h-auto mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3 @error('title') has-error @enderror">
                            ...
                            <input name="title" value="{{ old('title', $post->title ) }}" class="form-control  @error('title')  is-invalid @enderror">
                            @error('title')
                        ...
                        <div class="mb-3 @error('summary') has-error @enderror">
                            ...
                            <textarea name="summary" class="form-control  @error('summary')  is-invalid @enderror">{{ old('summary', $post->summary) }}</textarea>
                            @error('summary')
                                <small class="invalid-feedback">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="@error('content') is-invalid @enderror">
                            ...
                            <textarea name="content" class="summernote">{{ clean(old('content', $post->content)) }}</textarea>
                            @error('content')
                                <small class="d-block invalid-feedback">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="col-sm-12 col-md-4 mb-auto">
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        ...
                        <select class="w-100 form-control mr-sm-2" name="category_id">
