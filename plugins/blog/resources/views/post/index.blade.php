                                    ...
                                    <td>
                                        <span class="d-flex justify-content-around">
                                            <a href="{{ route('posts.show', $value->id) }}"
                                                class="btn btn-primary text-white" target="_blank"><i class="fas fa-eye"></i></a>
                                            <a href="{{ route('posts.edit', $value->id) }}"
                                                    class="btn btn-info text-white mx-1"><i class="fas fa-pen"></i></a>

                                                <a href="{{ route('posts.destroy', $value->id) }}"
                                                class="btn btn-danger text-white" data-toggle="tooltip"
